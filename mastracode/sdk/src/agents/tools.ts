...
import { getConfiguredWebToolsProvider, requestSandboxAccessTool } from '../tools/index.js';
...
export function createDynamicTools(
  ...
  return function getDynamicTools({
    ...
    if (configuredWebToolsProvider) {
      tools.web_search = configuredWebToolsProvider.createSearchTool();
      tools.web_extract = configuredWebToolsProvider.createExtractTool();
